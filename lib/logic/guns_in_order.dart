...
///Получаем список пушек в ордере
...
Future<List<GunInOrder>> insertGunsInOrder(String token, List<int> gunInOrderIds,
    List<int> quantities, List<int> sums,  int orderId) async {
  ...
  var response = await dio.post(connection + "newguninorder", data: formData,  options: Options(headers: {
    "Authorization" : "Bearer $token"
  }),);
