...
class GunInOrderStorekeeperPage extends StatefulWidget {
  final User _user;
  final int _id;
  GunInOrderStorekeeperPage(this._user, this._id);

  _GunInOrderStorekeeperPageState createState() => _GunInOrderStorekeeperPageState(_user, _id);
}

class _GunInOrderStorekeeperPageState extends State<GunInOrderStorekeeperPage> {
  final User _user;
  final int _id;
  _GunInOrderStorekeeperPageState(this._user, this._id);
